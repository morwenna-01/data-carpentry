...
def create_plot(clim, model_name, season, gridlines=False, levels=False):
    ...
    Kwargs:
      ...
      levels (numpy): Explicitly state the contour levels
...
def main(inargs):
    ...
    create_plot(clim, dset.attrs['model_id'], inargs.season, 
        gridlines=args.gridlines, levels=args.levels)
